...
class HomeFooter extends HBox {
    ...
    private Button newRecipeButton, filterMealTypeButton, autoLoginButton;
    ...
    HomeFooter() {
        ...
        this.getChildren().addAll(newRecipeButton, filterMealTypeButton, autoLoginContainer); // adding button to footer
