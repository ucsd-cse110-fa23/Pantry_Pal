...
public class whisperApiHandler implements HttpHandler {
    ...
    private String handlePost(HttpExchange httpExchange) throws IOException, InterruptedException, URISyntaxException{
      ...
      String FILE_TO_RECEIVED = "transcribe.wav";
      ...
      generatedText = transcribeIngredients("transcribe.wav");
    ...
    public static String mealType(String foo){
        String food = foo.toLowerCase();
        System.out.println("PRINTING: " + food);
        if(food.contains("breakfast")){
            return "breakfast";
        }
        else if(food.contains("lunch")){
            return "lunch";
        }
        else if(food.contains("dinner")){
            return "dinner";
        }
        else{
            return foo;
    ...
    public static String transcribeIngredients(String path) throws IOException, URISyntaxException {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            ingredientsString = handleErrorResponse(connection);
        }
